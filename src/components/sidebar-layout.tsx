            ...
            {module.lessons.map((lesson) => (
              <li
                ...
                className={clsx(
                  ...
                  "has-aria-[current=page]:border-brand dark:has-aria-[current=page]:border-brand",
                )}
              >
                <Link
                  href={`/${lesson.id}`}
                  ...
                  className="aria-[current=page]:font-medium aria-[current=page]:text-brand-deep dark:aria-[current=page]:text-brand"
                >
                  {lesson.title}
                </Link>
              </li>
