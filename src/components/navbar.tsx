          ...
          <div className="mt-4">
            <div className="flex flex-col gap-y-2">
              ...
              <CloseButton
                ...
                className="block rounded-md px-4 py-1.5 text-lg/7 font-medium tracking-tight text-brand hover:bg-brand-faint dark:hover:bg-white/5"
              >
                Get interviewed
              </CloseButton>
            </div>
  ...
  return (
    <nav className="flex items-center">
      ...
      <div className="flex items-center gap-x-6 text-sm/6 text-gray-950 max-lg:hidden dark:text-white">
        ...
        <a
          href="https://calendly.com/chinat/hackathon-interview"
          className="rounded-full bg-brand px-3 py-0.5 font-semibold text-white hover:bg-brand-deep"
        >
          Get interviewed
        </a>
      </div>
